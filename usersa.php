...
<html lang="en">
  ...
  <!-- Content here -->
    ...
    <div class="text-end ">
    <button name="sign_up_submit" type="submit" class="btn btn-primary"> Create </button>
  
    <button name="sign_up_submit" type="submit" class="btn btn-primary"> Edit </button>
    <button name="sign_up_submit" type="submit" class="btn btn-primary"> View </button>
  
    <button name="sign_up_submit" type="submit" class="btn btn-primary"> Delete </button>
  </div>
